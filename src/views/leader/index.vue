<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column label="头像" prop="title" width="100" height="100">
            ...
            <el-table-column label="名字" min-width="80px">
                <template slot-scope="{ row }">
        ...
        >
            ...
            >
                ...
                <el-form-item label="出生年月" prop="bith">
                    <el-input v-model="temp.birth" />
                </el-form-item>
                <el-form-item label="籍贯" prop="domicile">
                    <el-input v-model="temp.domicile" />
                </el-form-item>
                <el-form-item label="部门" prop="department">
                    <el-input v-model="temp.department" />
                </el-form-item>
                <el-form-item label="联系方式" prop="contact_way">
                    <el-input v-model="temp.contact_way" />
                </el-form-item>
                <el-form-item label="地址" prop="address">
                    <el-input v-model="temp.address" />
                </el-form-item>
                <el-form-item label="工作简历" prop="remark">
                    <tinymce v-model="temp.remark" :height="300" />
                </el-form-item>
            </el-form>
