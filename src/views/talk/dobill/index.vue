    ...
    <div class="app-container">
        ...
        <el-form :inline="true" :model="query" size="mini">
            ...
            <el-form-item>
                ...
                <el-button icon="el-icon-download" v-waves type="primary"  @click="handleDownload" >导出</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table
            ...
            <el-table-column  align="center" label="操作" width="80" >
                <template slot-scope="scope">
                    ...
                    <el-button type="danger"  @click="handleDelete(scope.row.id)"  size="mini">处理</el-button>
                </template>
            </el-table-column>
        </el-table>
